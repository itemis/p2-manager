...
public class Methods {
	...
	//repo to neo: String neo4jUrl, URI repoQueryLocation, int parentNeoId
	//units to neo: String neo4jUrl, int neoId, URI repoQueryLocation 
	...
	public void addChildrenRepositories(String neo4jUrl, List<URI> childrenLocations, int parentId) {
		for (URI childLocation : childrenLocations) {
			Date start = new Date();
			addChildRepository(neo4jUrl, childLocation, parentId);
